...
public class AddFruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //侧滑菜单
        mActionBar.setData(myActivity,"编辑信息", R.drawable.ic_back, 0, 0, getResources().getColor(R.color.colorPrimary), new ActionBar.ActionBarClickListener() {
            @Override
    ...
    public void save(View view){
        ...
        if (fruit == null ){
            ...
            setResult(RESULT_OK);
            finish();
            Toast.makeText(myActivity,"Saved successfully", Toast.LENGTH_LONG).show();
        }else {
